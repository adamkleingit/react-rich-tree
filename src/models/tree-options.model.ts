...
export class TreeOptions {
  ...
  get scrollOnSelect(): boolean {
    return this.options.scrollOnSelect === undefined ? true : this.options.scrollOnSelect;
  }
  get LoadingComponent(): any { return this.options.LoadingComponent; }
  get TreeNodeComponent(): any { return this.options.TreeNodeComponent; }
  get TreeNodeWrapperComponent(): any { return this.options.TreeNodeWrapperComponent; }
  get TreeNodeFullComponent(): any { return this.options.TreeNodeFullComponent; }
